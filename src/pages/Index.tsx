    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <main className="relative z-10 container mx-auto px-4 py-8 sm:py-12 md:py-20">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-md sm:max-w-xl mx-auto px-2">
          ...
          <motion.div
            ...
            className="mt-4 sm:mt-6 flex flex-col sm:flex-row items-center justify-center gap-2 text-muted-foreground px-2"
          >
            <span className="text-xs sm:text-sm text-center">Paste a YouTube link below to get started</span>
        ...
        <motion.div
          ...
          className="mt-12 sm:mt-16 md:mt-28"
        >
      ...
      {/* Footer */}
      <footer className="relative z-10 py-4 sm:py-6 text-center text-xs sm:text-sm text-muted-foreground px-2">
